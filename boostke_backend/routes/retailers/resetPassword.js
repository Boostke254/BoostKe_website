...
/**
 * @route POST /api/retailers/request-password-reset
...
router.post("/request-password-reset", async (req, res) => {
  ...
  try {
    ...
    if (user.rows.length === 0) {
      return res
        .status(404)
        .json({ error: "Retailer with this email not found." });
    }
    ...
    await pool.query(
      `UPDATE retailers SET reset_code = $1, reset_code_expiry = NOW() + INTERVAL '15 minutes' WHERE email = $2`,
      [resetCode, email]
    );
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <p>
          This code is valid for 15 minutes. If you did not request this, please ignore this email or contact our
...
/**
 * @route POST /api/retailers/verify-reset-code
...
/**
 * @route POST /api/retailers/reset-password
 * @description Reset the retailer's password after code verification
 * @access Public
 */
